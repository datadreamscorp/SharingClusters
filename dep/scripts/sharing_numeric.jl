...
# ╔═╡ 89a5b6a8-b915-11ec-2362-f97c6f960e5f
using Random, AlgebraOfGraphics, DataFrames

# ╔═╡ 2b407533-24f5-4ff9-878f-30f543eccc24
...
# ╔═╡ 9b4309d9-8a29-4e23-9ca4-e871703b79b7
function sharer(u, s, B, C, k_i, k_bar, T, v_0)
	...
	for t in 1:T
		...
		k = sum( [rand() < u ? 1 : 0 for i in 1:k_i] )
		lim = (s*k*B/k_bar - k_i*C > 0)
		
		if rand(Float64) < u
			v_t = v[t] * ( lim ? (1-s)*B + s*k*B/k_bar - k_i*C : 1 )
		else
			v_t = v[t] * ( lim ? 1 + s*k*B/k_bar - k_i*C : 1 )
		end
...
# ╔═╡ 31d45b2b-9aa1-44f4-a07b-24e88c9ad5a9
loner(0.5, 10, 200, 1.5)

# ╔═╡ b31b1677-2a62-49e7-9b1e-2874c139672a
sharer(0.5, 9/10, 10, 0.1, 2, 2, 200, 1.5)

# ╔═╡ d212a044-2e43-413e-9436-eb49789d42d7
sharer(0.5, 9/10, 10, 0.1, 5, 5, 200, 1.5)

# ╔═╡ f29e422d-eed8-4289-87b1-7f8ecb2afdd9
sharer(0.5, 9/10, 10, 0.1, 10, 10, 200, 1.5)

# ╔═╡ 42ae6b83-d256-418a-9b14-65e351529088
sharer(0.5, 9/10, 10, 0.1, 20, 20, 200, 1.5)

# ╔═╡ 115b5019-5f68-4d01-ba7b-29c3676d21ba
sharer(0.5, 9/10, 10, 0.1, 30, 30, 200, 1.5)

# ╔═╡ b6342f09-23be-4f9d-96b7-ce7fce469f5b
sharer(0.5, 9/10, 10, 0.1, 50, 50, 200, 1.5)
